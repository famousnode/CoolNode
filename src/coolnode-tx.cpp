...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("coolnode Core coolnode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  coolnode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coolnode transaction") + "\n" +
                               "  coolnode-tx [options] -create [commands]   " + _("Create hex-encoded coolnode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded coolnode transaction
