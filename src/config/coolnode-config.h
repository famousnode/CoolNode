/* src/config/coolnode-config.h.  Generated from coolnode-config.h.in by configure.  */
/* src/config/coolnode-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://coolnode.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "coolnode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "coolnode Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "coolnode"
