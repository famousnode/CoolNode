...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("coolnode Core"),
     ...
     * override -datadir in the coolnode.conf file in the default data directory
     * (to be consistent with vivaldid behavior)
     */
    if (dataDir != getDefaultDataDirectory())
