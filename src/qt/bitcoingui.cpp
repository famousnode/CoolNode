                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("coolnode-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a coolnode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and coolnode: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About coolnode Core"), this);
    aboutAction->setStatusTip(tr("Show information about coolnode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for coolnode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your coolnode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified coolnode addresses"));
    ...
    openAction->setStatusTip(tr("Open a coolnode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the coolnode Core help message to get a list with possible coolnode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("coolnode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to coolnode network", "", count));
}
...
{
    QString strTitle = tr("coolnode Core"); // default title
