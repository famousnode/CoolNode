...
/** Utility functions used by the COOL Qt UI.
 */
namespace GUIUtil
{
...
// Render COOL addresses in monospace font
...
// Parse "coolnode:" URI into recipient object, return true on successful parsing
