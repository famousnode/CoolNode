...
COINDOWNLOADLINK1=https://github.com/famousnode/coolnode/releases/download/1.1.1.1/coolnoded
COINDOWNLOADLINK2=https://github.com/famousnode/coolnode/releases/download/1.1.1.1/coolnode-cli
COINDOWNLOADLINK3=https://github.com/famousnode/coolnode/releases/download/1.1.1.1/coolnode-tx
COINPORT=11997
COINRPCPORT=11996
COINDAEMON=coolnoded
COINDAEMONCLI=coolnode-cli
COINDAEMONTX=coolnode-tx
COINCORE=.coolnode
COINCONFIG=coolnode.conf
...
configureWallet() {
    ...
    echo -e "rpcuser=${rpcuser}\nrpcpassword=${rpcpass}\nrpcallowip=127.0.0.1\nport=${port}\nrpcport=${rpcport}\ndaemon=1\nserver=1\nlisten=1\nlogtimestamps=1\nmaxconnections=256\nmasternode=1\nexternalip=${mnip}\nmasternodeprivkey=${mnkey}\naddnode=80.211.86.211:11997\naddnode=80.211.84.14:11997\naddnode=86.101.238.57:11997" > ~/$COINCORE/$COINCONFIG
...
echo -e "------------------------------------------------------------"
echo -e "|                                                          |"
echo -e "|        ${BOLD}---- COOL masternode installer ----${NONE}        |"
echo -e "|                                                          |"
echo -e "------------------------------------------------------------"

echo -e "${BOLD}"
read -p "This script will install a COOL masternode wallet on your VPS. Do you wish to continue? (y/n)?" response
echo -e "${NONE}"
