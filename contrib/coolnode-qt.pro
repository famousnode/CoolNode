...
RESOURCES += src/qt/coolnode.qrc src/qt/vivaldi_locale.qrc

TRANSLATIONS += src/qt/locale/vivaldi_bg.ts \
                src/qt/locale/vivaldi_de.ts \
                src/qt/locale/vivaldi_en.ts \
                src/qt/locale/vivaldi_es.ts \
                src/qt/locale/vivaldi_fi.ts \
                src/qt/locale/vivaldi_fr.ts \
                src/qt/locale/vivaldi_it.ts \
                src/qt/locale/vivaldi_ja.ts \
                src/qt/locale/vivaldi_pl.ts \
                src/qt/locale/vivaldi_pt.ts \
                src/qt/locale/vivaldi_ru.ts \
                src/qt/locale/vivaldi_sk.ts \
                src/qt/locale/vivaldi_sv.ts \
                src/qt/locale/vivaldi_vi.ts \
                src/qt/locale/vivaldi_zh_CN.ts \
                src/qt/locale/vivaldi_zh_TW.ts
